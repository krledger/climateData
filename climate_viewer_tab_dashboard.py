...
def render_dashboard_tab(
    ...
    Args:
        ...
        dashboard_location: Selected dashboard location (unused)
    ...
    for location_idx, dashboard_location in enumerate(loc_sel):
        ...
        st.markdown(f"## 📍 {dashboard_location}")
        
        # Prepare dashboard data
        with st.spinner(f"Calculating dashboard metrics for {dashboard_location}..."):
            ...
            if dashboard_data.empty:
                st.warning(f"⚠️ No data available for {dashboard_location} and selected scenarios.")
                continue
